...
export const reviews = mysqlTable("reviews", {
  ...
  professorsScore: int("professors_score"),
  advisorsScore: int("advisors_score"),
  outcomesScore: int("outcomes_score"),
  regretPercentage: int("regret_percentage"),
  reviewerGpa: varchar("reviewer_gpa", { length: 10 }),
